    ...
    return (
        <section className="instagram p-t-20">
            <div className="sec-title p-t-5 p-b-5 p-l-15 p-r-15">
                ...
                <p className="m-text5 t-center">@dclnchr @trggrdco</p>
            </div>
            ...
            <div className="flex-w">
                ...
                <div className="block4 wrap-pic-w">
                    ...
                    <a href="https://www.instagram.com/dclnchr/" target="_blank" rel="noopener noreferrer" className="block4-overlay sizefull ab-t-l trans-0-4">
